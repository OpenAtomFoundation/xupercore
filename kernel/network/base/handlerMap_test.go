...
func NewMockSubscriber(msgCh chan *xuperp2p.XuperMessage, msgType xuperp2p.XuperMessage_MessageType,
	handler XuperHandler, msgFrom string, log logs.Logger) *MockSubscriber {
	sub := &MockSubscriber{}
