...
func NewPluggableConsensus(cCtx cctx.ConsensusCtx, kContractHandler context.FakeRegistry) (ConsensusInterface, error) {
	...
	// TODO: 合约是否能够提供方法，简单的bucketName和XModel直接
