...
func HandlerError(err error) map[string]interface{} {
	...
	case nil:
		return map[string]interface{}{
			"code": ReturnCode_RETURNSUCCESS,
			"msg":  "success",
			"data": &map[string]string{},
		}
	case ErrFileNotExist:
		return map[string]interface{}{
			"code": ReturnCode_FILENOTEXIST,
			"msg":  ErrFileNotExist.Error(),
			"data": &map[string]string{},
		}
	case ErrParam:
		return map[string]interface{}{
			"code": ReturnCode_PARAMERR,
			"msg":  ErrParam.Error(),
			"data": &map[string]string{},
		}
	case ErrRequestFailed:
		return map[string]interface{}{
			"code": ReturnCode_HTTPREQUERTFAIL,
			"msg":  ErrRequestFailed.Error(),
			"data": &map[string]string{},
		}
	case ErrReadResponseFailed:
		return map[string]interface{}{
			"code": ReturnCode_HTTPRESPONSEFAIL,
	...
	case ErrAccountNotExist:
		return map[string]interface{}{
			"code": ReturnCode_ACCOUNTNOTEXIST,
			"msg":  ErrAccountNotExist.Error(),
			"data": &map[string]string{},
		}
	case ErrPwNotExist:
		return map[string]interface{}{
			"code": ReturnCode_PWNOTEXIST,
			"msg":  ErrPwNotExist.Error(),
			"data": &map[string]string{},
		}
	case ErrPwExist:
		return map[string]interface{}{
			"code": ReturnCode_PWEXIST,
