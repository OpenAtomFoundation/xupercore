...
import (
	...
	"github.com/xuperchain/xupercore/lib/crypto/multisign"
...
func XuperSigVerify(keys []*ecdsa.PublicKey, signature, message []byte) (bool, error) {
	...
	if err != nil {
		...
		case common.CurveNistSN: // NIST + Schnorr
	...
	// Schnorr签名
	case common.Schnorr:
		if curveName == common.CurveNistSN {
	...
	case common.MultiSig:
		if curveName == common.CurveNist || curveName == common.CurveNistSN {
