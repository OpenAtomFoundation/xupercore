...
import (
	...
	"github.com/xuperchain/xupercore/lib/crypto/common"
	"github.com/xuperchain/xupercore/lib/crypto/ecies"
	"github.com/xuperchain/xupercore/lib/crypto/hdwallet/key"
	walletRand "github.com/xuperchain/xupercore/lib/crypto/hdwallet/rand"
	"github.com/xuperchain/xupercore/lib/crypto/sign"
	"github.com/xuperchain/xupercore/lib/crypto/utils"

	"github.com/xuperchain/xupercore/lib/crypto/client/gm/gmsm/multisign"
	"github.com/xuperchain/xupercore/lib/crypto/client/gm/gmsm/schnorr_ring_sign"
	"github.com/xuperchain/xupercore/lib/crypto/client/gm/gmsm/schnorr_sign"
	"github.com/xuperchain/xupercore/lib/crypto/client/gm/gmsm/signature"
	"github.com/xuperchain/xupercore/lib/crypto/client/gm/gmsm/sm2"
	"github.com/xuperchain/xupercore/lib/crypto/client/gm/gmsm/sm3"
	"github.com/xuperchain/xupercore/lib/crypto/client/gm/gmsm/sm4"
)
...
func (gmcc GmCryptoClient) SignECDSA(k *ecdsa.PrivateKey, msg []byte) ([]byte, error) {
	...
	case common.CurveNist: // NIST
		signature, err := sign.SignECDSA(k, msg)
		return signature, err
	case common.CurveGm: // 国密
