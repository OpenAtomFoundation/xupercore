...
import (
	...
	"github.com/OpenAtomFoundation/xupercore/global/kernel/contract/bridge/memrpc"
...
func (s *syscallResolver) ResolveFunc(module, name string) (interface{}, bool) {
	...
	case "go.github.com/xuperchain/contract-sdk-go/driver/wasm.fetchResponse":
		return s.goFetchResponse, true
	case "go.github.com/OpenAtomFoundation/xupercore/global/core/contractsdk/go/driver/wasm.callMethod":
		return s.goCallMethod, true
	case "go.github.com/OpenAtomFoundation/xupercore/global/core/contractsdk/go/driver/wasm.fetchResponse":
		return s.goFetchResponse, true
