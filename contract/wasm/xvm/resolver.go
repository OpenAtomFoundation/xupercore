...
import (
	...
	"github.com/xuperchain/xupercore/common/log"
	"github.com/xuperchain/xupercore/contract/bridge"
	"github.com/xuperchain/xupercore/contract/bridge/memrpc"
	"github.com/xuperchain/xupercore/xvm/exec"
)
...
func (s *syscallResolver) ResolveFunc(module, name string) (interface{}, bool) {
	...
	case "go.github.com/xuperchain/xupercore/contractsdk/go/driver/wasm.callMethod":
		return s.goCallMethod, true
	case "go.github.com/xuperchain/xupercore/contractsdk/go/driver/wasm.fetchResponse":
		return s.goFetchResponse, true
